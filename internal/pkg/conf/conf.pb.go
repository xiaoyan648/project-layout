...
func (x *Content) GetServer() *Server {
	if x != nil {
		return x.Server
	}
	return nil
...
type Server_HTTP struct {
	...
	Port    int               `protobuf:"bytes,2,opt,name=port,proto3" json:"port,omitempty"`
...
func (x *Server_HTTP) GetPort() int {
	if x != nil {
		return x.Port
	}
	return 8080
...
func (x *Server_GRPC) GetPort() int {
	if x != nil {
		return x.Port
	}
	return 3000
...
var file_conf_conf_proto_goTypes = []interface{}{
	(*Content)(nil),           // 0: leo.api.Content
	(*Server)(nil),              // 1: leo.api.Server
	(*Data)(nil),                // 2: leo.api.Data
	(*Server_HTTP)(nil),         // 3: leo.api.Server.HTTP
	(*Server_GRPC)(nil),         // 4: leo.api.Server.GRPC
	(*Data_Database)(nil),       // 5: leo.api.Data.Database
	(*Data_Redis)(nil),          // 6: leo.api.Data.Redis
	(*durationpb.Duration)(nil), // 7: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: leo.api.Content.server:type_name -> leo.api.Server
	2,  // 1: leo.api.Content.data:type_name -> leo.api.Data
	3,  // 2: leo.api.Server.http:type_name -> leo.api.Server.HTTP
	4,  // 3: leo.api.Server.grpc:type_name -> leo.api.Server.GRPC
	5,  // 4: leo.api.Data.database:type_name -> leo.api.Data.Database
	6,  // 5: leo.api.Data.redis:type_name -> leo.api.Data.Redis
	7,  // 6: leo.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: leo.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: leo.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: leo.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
