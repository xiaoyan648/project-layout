...
//go:generate gen_error -type=int
//go:generate gen_error -type=int -doc -output ../../../api/docs/api_error.md
...
const (
	...
	// ErrTokenProjectNotSoupport - 401: The token does not support this project's functions.
	ErrTokenProjectNotSoupport
)
