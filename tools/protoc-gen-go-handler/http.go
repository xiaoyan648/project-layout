...
const (
	...
	// codePackage    = protogen.GoImportPath("github.com/xiaoyan648/project-layout/internal/pkg/code")
	ginPackage    = protogen.GoImportPath("github.com/gin-gonic/gin")
	serverPackage = protogen.GoImportPath("github.com/go-leo/leo/runner/net/http/server")
	errorsPackage = protogen.GoImportPath("github.com/xiaoyan648/project-layout/pkg/errors")
)

var methodSets = make(map[string]int)

// generateFile generates a _http.pb.go file containing leo errors definitions.
...
// generateFileContent generates the leo errors definitions, excluding the package statement.
